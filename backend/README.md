...
## Project Structure
    ...
    ├── testapiautosetting_125700  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125700`
...
2. Clone this repo and `cd testapiautosetting_125700`
